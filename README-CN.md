...
- **版本**: 1.0.0
- **路径**: `skills/workflow-skill-designer`
...
│   └── index.json          # 技能注册表
├── skills/
│   ├── project-analyze/    # 项目分析技能
│   ├── copyright-docs/     # 软著文档技能
│   ├── software-manual/    # 软件手册技能
│   ├── skill-generator/    # 技能生成器
│   ├── skill-tuning/       # 技能调优
│   └── workflow-skill-designer/  # 工作流设计器
├── scripts/
